...
const GroupTableHeader: React.FC = (prop) => {
  ...
  return (
    <div className="workingTableHeader">
      <div className="workingTableHeader-logo" style={{ width: '56px' }}>
      ...
      <img src={infoPng} alt="" style={{width:'30px',height:'30px',marginRight:'30px'}}/>
      <img src={chatPng} alt=""  style={{width:'27px',height:'25px',marginRight:'20px'}}/>
      <img src={filePng} alt=""  style={{width:'30px',height:'25px',marginRight:'30px'}}/>
